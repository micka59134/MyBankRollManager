...
const COMPETITION_LOGOS = {
  ...
  'Ligue des Champions': 'championsleague.png',
...
function renderCards(entries) {
  ...
  const cards = [
    ...
    { label: 'Montant gagné', value: fmtMoney(s.totalGagne), cls: s.totalGagne > 0 ? 'positive' : '' },
...
function updateMontantInvesti() {
  ...
  const investi = Math.max(0, depots - retraits);
